...
## Description 
### Week-1
1.  created  a static web page, the page consists of a table with set of links to products available
...
### Week-2
2. created a home page with nested frames consisting of 3 parts. A title frame describing
